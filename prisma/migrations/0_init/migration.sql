...
-- AddForeignKey
ALTER TABLE "order" ADD CONSTRAINT "order_operations_manager_id_fkey" FOREIGN KEY ("operations_manager_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
